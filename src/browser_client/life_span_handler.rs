...
/// TODO: define safe, high level interface
#[allow(unused_variables)]
pub trait LifeSpanHandler: 'static {}

impl LifeSpanHandler for () {}

#[repr(C)]
pub struct LifeSpanHandlerWrapper<T: LifeSpanHandler> {
    vtable: cef_life_span_handler_t,
    callback: T,
}

unsafe impl<T: LifeSpanHandler> Is<cef_base_ref_counted_t> for LifeSpanHandlerWrapper<T> {}
unsafe impl<T: LifeSpanHandler> Is<cef_life_span_handler_t> for LifeSpanHandlerWrapper<T> {}
...
impl<T: LifeSpanHandler> LifeSpanHandlerWrapper<T> {
    #[allow(unused_variables)]
    pub fn new(wrapped: T) -> CefRc<LifeSpanHandlerWrapper<T>> {
        ...
        CefRc::make(move |base| {
            LifeSpanHandlerWrapper {
                vtable: cef_life_span_handler_t {
                    base: base,
                    on_before_popup: Some(on_before_popup_ffi),
                    on_after_created: Some(on_after_created_ffi),
                    do_close: Some(do_close_ffi),
                    on_before_close: Some(on_before_close_ffi),
                },
                callback: wrapped,
            }
        })
